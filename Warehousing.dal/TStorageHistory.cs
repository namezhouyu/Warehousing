...
namespace Warehousing.dal
{
	...
	public partial class TStorageHistory
	{
		...
		public int GetMaxId()
		{
            return DbHelperSQLite.GetMaxID("id", "TStorageHistory"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from TStorageHistory");
		...
		public int Add(Warehousing.model.TStorageHistory model)
		{
			...
			strSql.Append("insert into TStorageHistory(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TStorageHistory set ");
			if (model.goodId != 0)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TStorageHistory ");
			strSql.Append(" where id="+id+"" );
			int rowsAffected=DbHelperSQLite.ExecuteSql(strSql.ToString());
			if (rowsAffected > 0)
			{
		...
		public Warehousing.model.TStorageHistory GetModel(int id)
		{
			...
			strSql.Append(" from TStorageHistory ");
			strSql.Append(" where id="+id+"" );
			Warehousing.model.TStorageHistory model=new Warehousing.model.TStorageHistory();
		...
		/// 得到一个对象实体
		/// </summary>
		public Warehousing.model.TStorageHistory DataRowToModel(DataRow row)
		{
			Warehousing.model.TStorageHistory model=new Warehousing.model.TStorageHistory();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TStorageHistory T ");
